...
data2 = ('moda', ('走', '了'), ('買', '肥宅', '歡樂水'))
index1= data2.index(('買', '肥宅', '歡樂水'))
index2= data2[index1].index('歡樂水')
print(data2[index1][index2])
...
data3=list(data3)
data3.sort()
print('data3_max:'+str(data3[0])+' data3_min:'+str(data3[-1]))
data3.sort(reverse=True)
data_desc=data3
data_asc= sorted(data3)
print('data_desc:'+str(data_desc))
print('data_asc:'+str(data_asc))
